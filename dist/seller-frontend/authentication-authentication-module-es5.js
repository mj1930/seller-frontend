(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["authentication-authentication-module"], {
    ...
    function OpKh(module, __webpack_exports__, __webpack_require__) {
      ...
      var _http_interceptor__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ../http-interceptor */
      "WeEj");
      ...
      AuthenticationModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        ...
        providers: [_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"], _http_interceptor__WEBPACK_IMPORTED_MODULE_9__["httpInterceptorProviders"]],
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _authentication_routing_module__WEBPACK_IMPORTED_MODULE_4__["AuthenticationRoutingModule"], angular_bootstrap_md__WEBPACK_IMPORTED_MODULE_6__["MDBBootstrapModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpClientModule"]]]
      });
    ...
    function ionX(module, __webpack_exports__, __webpack_require__) {
      ...
      var routes = [//{path: '', pathMatch: 'full', redirectTo: '/register'},
      {
        path: 'register',
    ...
    function kuBs(module, __webpack_exports__, __webpack_require__) {
      ...
      function LoginComponent_span_18_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](ctx_r3.loginError);
        }
      }

      var LoginComponent = /*#__PURE__*/function () {
        function LoginComponent(fb, authService, router, toastService) {
        ...
        _createClass(LoginComponent, [{
          ...
          value: function login(valid) {
            ...
            this.authService.login(reqData).subscribe(function (data) {
              if (data.code === 400) {
                console.log("Error", data.message);
                var errorMessage = data.message ? data.message : "Unknown Error Occured!";

                _this.toastService.openSnackbar(errorMessage);
              ...
              if (data.code === 200) {
                ...
                if (_this.loginForm.controls["rememberMe"].value) {
                  localStorage.setItem("remember", JSON.stringify(true));
                  localStorage.setItem("email", _this.loginForm.controls["email"].value);
                ...
                if (userData && userData.accountNumber) _this.router.navigateByUrl("/seller/active-dashboard");else _this.router.navigateByUrl("/seller/active-dashboard");
              } else {
                _this.loginError = data["messgae"];
              }
            }, function (error) {
              console.log(error);
            });
      ...
      LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 44,
        vars: 5,
        consts: [[1, "container-fluid"], [1, "row", "d-flex", "justify-content-center"], [1, "col-md-5", "col-lg-4", "col-sm-8"], [1, "card"], [1, "card-body"], [1, "card-title"], [1, "text-left", 3, "formGroup", "ngSubmit"], ["for", "", 1, "m-0", "small", "mt-4"], ["formControlName", "email", "type", "email", "id", "defaultLoginFormEmail", "placeholder", "E-mail", 1, "form-control"], ["class", "deep-orange-text small m-0", 4, "ngIf"], ["formControlName", "password", "type", "password", "id", "defaultLoginFormPassword", "placeholder", "Password", 1, "form-control"], [4, "ngIf"], [1, "d-md-flex", "d-block", "mt-3", "justify-content-between"], [1, "custom-control", "custom-checkbox"], ["name", "rememberMe", "formControlName", "rememberMe", "type", "checkbox", "id", "defaultLoginFormRemember", 1, "custom-control-input"], ["for", "defaultLoginFormRemember", 1, "custom-control-label"], ["href", "", 1, "small"], ["type", "submit", 1, "btn", "elegant-color", "text-white", "btn-sm", "btn-block", "my-4", "rounded"], [1, "small"], ["href", ""], [1, "my-4"], [1, "d-flex", "justify-content-center"], [1, "mx-auto", "bg-white", "small", "d-inline-block", "px-2", "text-black-50", 2, "margin-top", "-36px"], ["href", "", "role", "button", 1, "btn-block", "unique-color", "text-white", "btn", "btn-sm", "rounded"], [1, "deep-orange-text", "small", "m-0"]],
        template: function LoginComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function LoginComponent_Template_form_ngSubmit_8_listener() {
              return ctx.login(ctx.loginForm.valid);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](12, LoginComponent_p_12_Template, 2, 0, "p", 9);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](13, LoginComponent_p_13_Template, 2, 0, "p", 9);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](17, LoginComponent_p_17_Template, 2, 0, "p", 9);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](31, "By continuing, you agree to our ");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](38, "hr", 20);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](39, "div", 21);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](40, "p", 22);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](41, "New Member ?");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](43, "Create your account");
          ...
          if (rf & 2) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", !ctx.loginForm.get("email").valid && ctx.loginAttempt && ctx.loginForm.get("email").hasError("required"));
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", !ctx.loginForm.get("password").valid && ctx.loginAttempt && ctx.loginForm.get("password").hasError("required"));
